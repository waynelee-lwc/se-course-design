...
async function getSchedule(req,res){
    ...
    sql = mysql.format(" SELECT *, course.name as course_name "  + 
                        ...
                        "   LEFT JOIN ( SELECT professor.name as professor_name, teach.cid as teach_cid FROM teach JOIN professor ON teach.pid = professor.pid ) AS tmp ON tmp.teach_cid = course.cid " + 
